...
contract GettingStartedFunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    function get_seed() external view returns(bytes){
        require(block.timestamp>fakeTS);
        return seed;
    }

    function setTS(uint256 _fakeTS) external {
        // OnlyOwner
        fakeTS = _fakeTS;
    }
    ...
    function fulfillRequest(
        ...
        emit Response(requestId, seed, s_lastError);
    }
}
